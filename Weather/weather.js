...
function onSucces(position){
    ...
    api =`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=${"21c7f7de0569556aa860dbaef6259ef4"}&lang={lang}`
    fetchData();
}
...
function requestApi(city){
    api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${"21c7f7de0569556aa860dbaef6259ef4"}`;
    fetchData();
}
